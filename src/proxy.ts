...
export const config = {
  // Exclude routes that must be handled outside the next-intl locale rewrites:
  // - /monitoring: Sentry tunnel route (forwards error envelopes)
  // - /apple-icon: dynamic Next.js icon route generated by app/apple-icon.tsx
  // - /icon: dynamic Next.js icon route (in case of future app/icon.tsx)
  matcher: ["/((?!_next/static|_next/image|favicon.ico|api|monitoring|apple-icon|icon).*)"],
};
