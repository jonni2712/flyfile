...
export default function LoginPage() {
  ...
  const handlePasswordLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : t('invalidPassword');
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : t('codeSendError');
      setError(errorMessage);
    }
  };
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : t('googleFailed');
      setError(errorMessage);
      setLoading(false);
    }
  };
        ...
        <div className="p-8">
              ...
              <div className="my-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center">
                    <span className="px-4 bg-white text-gray-400 text-sm">{t('or')}</span>
                  </div>
                </div>
              </div>
          ...
          {step === 'password' && (
            <>
              ...
              <p className="text-gray-500 text-center mb-6 text-sm">
                {t('passwordFor')} <strong className="text-gray-900">{email}</strong>
              </p>
          ...
          {step === 'code' && (
            <>
              ...
              <p className="text-gray-500 text-center mb-6 text-sm">
                {t('codeSentTo')} <strong className="text-gray-900">{email}</strong>
              </p>
