...
export default function TeamInvitePage() {
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      router.push('/team?joined=true' as any);
    } catch (err) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700 p-8">
          ...
          <div className="space-y-3">
            <Link
              href={`/accedi?redirect=/team/invite/${token}&email=${encodeURIComponent(invitation.invitation.email)}` as any}
            ...
            <Link
              href={`/registrati?redirect=/team/invite/${token}&email=${encodeURIComponent(invitation.invitation.email)}` as any}
      ...
      <div className="max-w-md w-full bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700 p-8">
        ...
        {!emailMatches && (
          <p className="text-center text-gray-500 text-sm mt-6">
            <Link href={"/logout" as any} className="text-primary-400 hover:text-primary-300">
              Esci
            </Link>
